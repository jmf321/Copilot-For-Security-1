...
[![Suspicious Promptbook 3](https://github.com/jmf321/CfS-Hands-On-Training/blob/main/Images/submitscriptpromptbook.png)](https://github.com/jmf321/CfS-Hands-On-Training/blob/main/Images/submitscriptpromptbook.png)
...
[![Suspicious Promptbook 4](https://github.com/jmf321/CfS-Hands-On-Training/blob/main/Images/analyzereport.png)](https://github.com/jmf321/CfS-Hands-On-Training/blob/main/Images/analyzereport.png)
...
[![Script Reputation](https://github.com/jmf321/CfS-Hands-On-Lab/blob/main/Images/scriptreputation.png)](https://github.com/jmf321/CfS-Hands-On-Lab/blob/main/Images/scriptreputation.png) 
[![Script Recommendation](https://github.com/jmf321/CfS-Hands-On-Lab/blob/main/Images/scriptrecommendation.png)](https://github.com/jmf321/CfS-Hands-On-Lab/blob/main/Images/scriptrecommendation.png)
...
[![Suspicious Promptbook 5](https://github.com/jmf321/CfS-Hands-On-Training/blob/main/Images/finalizedreport.png)](https://github.com/jmf321/CfS-Hands-On-Training/blob/main/Images/finalizedreport.png)
...
2. Access the Prompt Bar
   ...
   [![Prompt Bar](https://github.com/jmf321/CfS-Hands-On-Lab/blob/main/Images/promptbar1.png)](https://github.com/jmf321/CfS-Hands-On-Lab/blob/main/Images/promptbar1.png)
...
3. Add the Following Prompt
   ...
   ```
[![Cfscustomscript1](https://github.com/jmf321/CfS-Hands-On-Training/blob/main/Images/analyzescript1.png)](https://github.com/jmf321/CfS-Hands-On-Training/blob/main/Images/analyzescript1.png)

3. Add the Following Prompt
   ```
   /AskGpt Surface from the script the relevant pieces of information to investigate, as well as all the technical indicators
   ```
[![Cfscustomscript2](https://github.com/jmf321/CfS-Hands-On-Training/blob/main/Images/analyzescript2.png)](https://github.com/jmf321/CfS-Hands-On-Training/blob/main/Images/analyzescript2.png)

4. Add the Following Prompt
   ```
   /AskGpt Extract all external URLs and their associated domains from the script
   ```
[![Cfscustomscript3](https://github.com/jmf321/CfS-Hands-On-Training/blob/main/Images/analyzescript3.png)](https://github.com/jmf321/CfS-Hands-On-Training/blob/main/Images/analyzescript3.png)
...
5. Add the Following Prompt
   ...
   ```
[![Cfscustomscript4](https://github.com/jmf321/CfS-Hands-On-Training/blob/main/Images/analyzescript4.png)](https://github.com/jmf321/CfS-Hands-On-Training/blob/main/Images/analyzescript4.png)
...
6. Add the Following Prompt
   ...
   ```
[![Cfscustomscript5](https://github.com/jmf321/CfS-Hands-On-Training/blob/main/Images/analyzescript5.png)](https://github.com/jmf321/CfS-Hands-On-Training/blob/main/Images/analyzescript5.png)
...
2. **Scroll to the Prompt Bar:**
   ...
   ![cfsSCRIPTDECODE1](https://github.com/jmf321/CfS-Hands-On-Training/blob/main/Images/cfsSCRIPTDECODE1.png)

3. **On the search tab type Analyze a Script, and select Analyze a script or command in the system capabilities**

   [![cfsSCRIPTDECODE2](https://github.com/jmf321/CfS-Hands-On-Training/blob/main/Images/cfsSCRIPTDECODE2.png)](https://github.com/jmf321/CfS-Hands-On-Training/blob/main/Images/cfsSCRIPTDECODE2.png)
...
```
[![cfsSCRIPTDECODE3](https://github.com/jmf321/CfS-Hands-On-Training/blob/main/Images/cfsSCRIPTDECODE3.png)](https://github.com/jmf321/CfS-Hands-On-Training/blob/main/Images/cfsSCRIPTDECODE3.png)

5. After submission, review the generated report explaining the script.

[![cfsSCRIPTDECODE4](https://github.com/jmf321/CfS-Hands-On-Training/blob/main/Images/cfsSCRIPTDECODE4.png)](https://github.com/jmf321/CfS-Hands-On-Training/blob/main/Images/cfsSCRIPTDECODE4.png)

Click [here](https://aka.ms/CfSModule3) to complete the next Module.
